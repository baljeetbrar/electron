    ...
    <Container>
        <Row className="top-bottom-padding">
            ...
            <div className="fixdeals-wrapper ">
                <img src="https://baljeetbrar.github.io/design_one/images/livedeal1.webp" alt="Live Deal, " className='full-width'/>
            </div>
            </Col>
        ...
        <Row>
            <Col className="best-deals-wrapper">
                    <div className="intro-tag-box d-flex justify-content-center ">
                        <h1 className="primary-font text-bold">Best Online Deals, Free Stuff and Top Cashback Offers</h1>
